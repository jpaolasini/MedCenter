...
public class RegisterActivity extends Activity{
	...
	public void completeReg(View view) throws Exception
	{
		...
		if(firstName.getText().toString().matches(".*\\d.*") || lastName.getText().toString().matches(".*\\d.*") || bloodType.getText().toString().matches(".*\\d.*")){
		...
		else
		{
			...
			try{
				...
				String mergedData = UserInformation.mergePatientInfo(userName.getText().toString(), password.getText().toString(), firstName.getText().toString(),
						lastName.getText().toString(), patientType, height.getText().toString(), weight.getText().toString(), age.getText().toString(),
				...
				//String values = new String(AESencrp.decrypt(firstValue.getBytes()));
