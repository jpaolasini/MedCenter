...
public class UserInformation {
	...
	public static String mergePatientInfo(String username, String password, String firstName, String lastName,
			String userType, String height, String weight, String age, String bloodType) throws Exception
	{
		...
		String parser = "^*^*^";
		String mergedData = username1 + parser + password1 + parser + firstName1 + parser + lastName1 + parser + userType1 + parser +
							age1 + parser + weight1 + parser + height1 + parser + bloodType1;
		return mergedData;
	}
